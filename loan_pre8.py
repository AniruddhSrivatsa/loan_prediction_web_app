...
if st.checkbox("Predict"):
   ...
   if (pred==1 and reason !="none of the above" ):
     ...
     if (reason1!=""):
        st.write("FOR:",reason1)
     
    
   elif (pred==0 and reason !="none of the above"):
     st.write("We are sorry to announce that your loan will not be sanctioned for",reason)
   

   elif (pred==0 and reason =="none of the above"):

     if (reason1==""):
        st.write("We are sorry to announce that your loan will not be sanctioned")  
        
     elif(reason1!=""):   
        st.write("We are sorry to announce that your loan will not be sanctioned for:",reason1)
